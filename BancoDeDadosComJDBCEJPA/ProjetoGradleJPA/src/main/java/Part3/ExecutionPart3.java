...
public class ExecutionPart3 {
    ...
    public static void main(String[] args) {
        ...
        EntityManagerFactory entityManagerFactory = Persistence.createEntityManagerFactory("part2-JPA");
...
//                .createNativeQuery(sql, Aluno.class)  //query nativa= SQL - coloco a consulta em sql, digo que me retornará um aluno
//                .setParameter("nome", nome)  //parâmetro nome = daniel
//                .getSingleResult();   //vai me trazer apenas 1 resultado.
//
//        // Trazendo uma lista como resultado
